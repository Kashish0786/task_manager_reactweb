...
//         Hello <br />
//         <span className='text-3xl font-semibold'>Kassu 👋</span>
//       </h1>

//       <button 
//         onClick={logOutUser}
//         className='bg-gray-500 text-lg font-medium text-white px-5 py-2 rounded-sm 
//         hover:bg-gray-700 hover:scale-105 transition-all duration-300 cursor-pointer'>
//         Log Out
//       </button>
//     </div>
//   )
...
//         Hello 👋 <br />
//         <span className='text-3xl font-bold text-[#00f2ff] tracking-wide drop-shadow-[0_0_8px_#00f2ff]'>
//           {data.firstName }  {/* optional chaining for safety */}
//         </span>
//       </h1>
